...
import { Brain, Clock, PhoneCall, Ambulance, CheckCircle } from "lucide-react";

/* ================= DOCTOR DATA ================= */
const doctors = [
  {
    name: "Dr. Vaishali Dhadhe (Nimbalkar)",
    designation: "Brain & Spine Specialist",
    ...
    <>
      ...
      <section className="relative py-24 bg-gradient-to-r from-[#4b1d3f] to-[#7A0C0C] text-white overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          ...
          <p className="text-lg opacity-90 max-w-3xl">
            Advanced brain and spine care with precision surgery, modern
            technology and round-the-clock emergency support.
          </p>
        </div>
      </section>
        ...
        <div className="relative max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-slate-700 leading-relaxed mb-6">
              The Neurology & Neurosurgery department at City Multispecialty
              Hospital provides comprehensive care for disorders of the brain,
              spine and nervous system.
            </p>
            <p className="text-slate-700 leading-relaxed">
              Our specialists manage stroke, brain tumours, head injuries, spine
              disorders and pediatric neurological conditions using advanced
              surgical techniques and modern critical care facilities.
            </p>
          </motion.div>
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
            {[
              ...
              "Stroke & Brain Haemorrhage Management",
              "Head Injury & Accident Trauma Care",
              "Spine Surgery & Slip Disc Treatment",
              "Paralysis & Nerve Compression Treatment",
              "Pediatric Neurological Disorders",
              "Migraine, Dizziness & Chronic Headache Care",
            ].map((service, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 40 }}
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-10 justify-center">
            {doctors.map((doc, i) => (
              <motion.a
                key={i}
                href={`https://wa.me/${doc.whatsapp}?text=Hello%20Doctor,%20I%20would%20like%20to%20consult%20for%20a%20neurology%20or%20neurosurgery%20problem.`}
                target="_blank"
                whileHover={{ y: -8 }}
      ...
      <section className="py-24 bg-gradient-to-r from-[#4b1d3f] to-[#7A0C0C] text-white text-center">
        ...
        <h2 className="text-3xl font-bold mb-4">
          Stroke or Head Injury? Act Fast.
        </h2>
        <p className="opacity-90 mb-8">
          Immediate neuro emergency care available 24×7.
        </p>
        <a
